...
| cellStyleFocused  | React View StyleSheet                                                                 | `{ borderColor: 'red', borderWidth: 2 }`   | View style for focused cell                                                                                                                                                                                                                                        |
| cellStyleFilled   | React View StyleSheet                                                                 | `{ borderColor: 'black', borderWidth: 1 }` | View style for filled cells                                                                                                                                                                                                                                        |
| textStyle         | React Text StyleSheet                                                                 | `{ color: 'gray', fontSize: 24 }`          | Text style for cell value                                                                                                                                                                                                                                          |
| textStyleFocused  | React Text StyleSheet                                                                 | `{ color: 'red' }`                         | Text style for focused cell value                                                                                                                                                                                                                                  |
| textStyleFilled   | React Text StyleSheet                                                                 | `{ color: 'black' }`                       | Text style for filled cell values                                                                                                                                                                                                                                  |
